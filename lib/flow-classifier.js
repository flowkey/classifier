...
Classifier = function(parameters) {
    ...
    this.runMode = this.runModes.CLASSIFY;
...
_.extend(Classifier.prototype, {
    ...
    init: function(parameters) {
        ...
        if (parameters.specs) {
            ...
            console.warn("no training specs for classifier, using default data set");
    ...
    run: function() {
        ...
        } else if (self.runMode == self.runModes.CLASSIFY) {

            this.realTimeClassify();

        } else if (self.runMoe == self.runModes.CLASSIFY_OFFLINE) {

            this.classify();

        } else {
            console.warn("No classifier runMode specified!");
        }
    ...
    learn: function(resetNodeList) {
        var self = this;

        console.log("LEARNING FROM COLLECTED DATA IN STORAGE");
