...
Classifier = function(parameters) {
    ...
    this.musicBuffer = [false, false, false];
...
_.extend(Classifier.prototype, {
    init: function(parameters) {
        ...
        // self.features["chromarange"] = new ChromaRange({
        //     sampleRate: self.graph.audioContext.sampleRate / self.graph.graphSpec.downsampleAndOverlap.downsampleFactor,
        //     blockLength: self.blockLength
        // });
